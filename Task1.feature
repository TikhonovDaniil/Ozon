...
@low @positive
Сценарий: Я вставляю текст в поля логина и пароля
Пусть я открываю сайт "qa-testing.ru"
...
Тогда я авторизуюсь через Google
И я вижу "профиль Пользователя"
...
И нажимаю "кнопку Войти"
Тогда я понимаю, что авторизован, так как вижу "профиль Пользователя" и "ваш пароль запомнен"
